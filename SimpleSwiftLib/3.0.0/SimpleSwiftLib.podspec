...
Pod::Spec.new do |s|
  ...
  s.version          = '3.0.0'
  s.summary          = 'A simple swift class.'
  s.swift_version    = '4.0'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/elye/demo_ios_extlib_simple_swift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'elye' => 'elisha.lye@rea.group.com' }
  s.source           = { :git => 'https://github.com/elye/demo_ios_extlib_simple_swift.git', :tag => s.version.to_s }
